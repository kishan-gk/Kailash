...
export function Hero() {
  ...
  const headlineLine1 = hero?.headline_line1 ?? 'I Design Experiences,ssss';
  const headlineLine2 = hero?.headline_line2 ?? 'Not Just Interfaces.';
  const highlightWord = hero?.headline_highlight_word ?? 'Experiences';
  const description = hero?.description ?? "I'm a UI/UX designer focused on building intuitive, user-centered digital experiences.";

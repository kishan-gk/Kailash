import svgPaths from "./svg-hrew3m17sj";
...
function Group1() {
  return (
    <div className="absolute contents inset-[0_0_-118px_0]">
      <div className="absolute bg-gradient-to-r from-[rgba(8,6,12,0.6)] inset-[0_0_-118px_0] to-1/2 to-[rgba(8,6,12,0)]" data-name="Gradient" />
      <div className="absolute inset-[0_0_-118px_0]" data-name="Gradient" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\'0 0 1440 1000\' xmlns=\'http://www.w3.org/2000/svg\' preserveAspectRatio=\'none\'><rect x=\'0\' y=\'0\' height=\'100%\' width=\'100%\' fill=\'url(%23grad)\' opacity=\'1\'/><defs><radialGradient id=\'grad\' gradientUnits=\'userSpaceOnUse\' cx=\'0\' cy=\'0\' r=\'10\' gradientTransform=\'matrix(117 0 0 130 1080 500)\'><stop stop-color=\'rgba(96,50,242,0.18)\' offset=\'0\'/><stop stop-color=\'rgba(139,61,255,0.12)\' offset=\'0.25\'/><stop stop-color=\'rgba(139,61,255,0)\' offset=\'0.55\'/></radialGradient></defs></svg>')" }} />
...
function Group() {
  return (
    <div className="absolute inset-[0_16.09%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25.7688 38">
        <g id="Group">
...
function Hero() {
  return (
    <div className="bg-[#0b0815] content-stretch flex flex-col h-[882px] items-center overflow-clip pb-[100px] relative shrink-0 w-full" data-name="Hero">
      <Group1 />
      <Header />
      <Container />
    </div>
...
function Clients() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-start left-0 px-[80px] py-[40px] top-[801.61px] w-[1440px]" data-name="Clients">
...
function Svg3() {
  return (
    <div className="-translate-y-1/2 absolute left-[142.52px] size-[16px] top-1/2" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p154e6c80} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p22879fc0} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="absolute h-[24px] left-[32px] opacity-0 top-[674.5px] w-[158.52px]" data-name="Button">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[23px] justify-center leading-[0] left-[calc(50%-11.85px)] not-italic text-[16px] text-center text-white top-[calc(50%-0.5px)] w-[134.824px]">
        <p className="leading-[24px] whitespace-pre-wrap">View Case Study</p>
      </div>
      <Svg3 />
    </div>
  );
...
function FinanceFlowSaaS() {
  return (
    <div className="absolute inset-0 opacity-60" data-name="FinanceFlow SaaS">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[105.17%] left-0 max-w-none top-[-2.58%] w-full" src={imgFinanceFlowSaaS} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[24px] top-1/2" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="SVG">
          <path d="M7 7H17V17" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M7 17L17 7" id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Background1() {
  return (
    <div className="absolute bg-white left-[558px] opacity-0 rounded-[33554400px] size-[48px] top-[16px]" data-name="Background">
      <Svg4 />
    </div>
  );
}
...
function Background() {
  return (
    <div className="absolute aspect-[622/466.5] left-0 overflow-clip right-0 top-0" data-name="Background" style={{ backgroundImage: "linear-gradient(143.13deg, rgba(173, 70, 255, 0.2) 0%, rgba(246, 51, 154, 0.2) 100%)" }}>
      <FinanceFlowSaaS />
      <div className="absolute bg-gradient-to-t from-[#0a0a0a] inset-0 to-[rgba(10,10,10,0)] via-1/2 via-[rgba(10,10,10,0.5)]" data-name="Gradient" />
      <Background1 />
    </div>
  );
}
...
function OverlayBorder() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] border-solid h-[732.5px] left-0 overflow-clip right-[656px] rounded-[24px] top-[156px]" data-name="Overlay+Border">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[20px] justify-center leading-[0] left-[32px] not-italic text-[#c27aff] text-[14px] top-[510.5px] w-[94.726px]">
        <p className="leading-[20px] whitespace-pre-wrap">SaaS Product</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:SemiBold',sans-serif] h-[32px] justify-center leading-[0] left-[32px] not-italic text-[24px] text-white top-[554.5px] w-[221.84px]">
        <p className="leading-[32px] whitespace-pre-wrap">FinanceFlow SaaS</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Regular',sans-serif] h-[47px] justify-center leading-[24px] left-[32px] not-italic text-[#a1a1a1] text-[16px] top-[602px] w-[476.12px] whitespace-pre-wrap">
        <p className="mb-0">A comprehensive financial management platform for small</p>
        <p>businesses</p>
      </div>
      <Button1 />
      <Background />
...
function Button2() {
  return (
    <div className="absolute h-[24px] left-[32px] opacity-0 top-[650.5px] w-[158.52px]" data-name="Button">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[23px] justify-center leading-[0] left-[calc(50%-11.85px)] not-italic text-[16px] text-center text-white top-[calc(50%-0.5px)] w-[134.824px]">
        <p className="leading-[24px] whitespace-pre-wrap">View Case Study</p>
      </div>
      <Svg5 />
...
function MediCareMobileApp() {
  return (
    <div className="absolute inset-0 opacity-60" data-name="MediCare Mobile App">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[105.17%] left-0 max-w-none top-[-2.58%] w-full" src={imgFinanceFlowSaaS} />
      </div>
    </div>
...
function OverlayBorder1() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] border-solid h-[708.5px] left-[656px] overflow-clip right-0 rounded-[24px] top-[156px]" data-name="Overlay+Border">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[20px] justify-center leading-[0] left-[32px] not-italic text-[#c27aff] text-[14px] top-[510.5px] w-[79.512px]">
        <p className="leading-[20px] whitespace-pre-wrap">Mobile App</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:SemiBold',sans-serif] h-[32px] justify-center leading-[0] left-[32px] not-italic text-[24px] text-white top-[554.5px] w-[263.06px]">
        <p className="leading-[32px] whitespace-pre-wrap">MediCare Mobile App</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Regular',sans-serif] h-[24px] justify-center leading-[0] left-[32px] not-italic text-[#a1a1a1] text-[16px] top-[590.5px] w-[509.128px]">
        <p className="leading-[24px] whitespace-pre-wrap">Healthcare appointment scheduling and telemedicine platform</p>
      </div>
      <Button2 />
      <Background2 />
    </div>
...
function TechStartWebsite() {
  return (
    <div className="absolute inset-0 opacity-60" data-name="TechStart Website">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[105.17%] left-0 max-w-none top-[-2.58%] w-full" src={imgFinanceFlowSaaS} />
      </div>
    </div>
...
function OverlayBorder2() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] border-solid h-[708.5px] left-0 overflow-clip right-[656px] rounded-[24px] top-[920.5px]" data-name="Overlay+Border">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[20px] justify-center leading-[0] left-[32px] not-italic text-[#c27aff] text-[14px] top-[510.5px] w-[57.515px]">
        <p className="leading-[20px] whitespace-pre-wrap">Website</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:SemiBold',sans-serif] h-[32px] justify-center leading-[0] left-[32px] not-italic text-[24px] text-white top-[554.5px] w-[227.11px]">
        <p className="leading-[32px] whitespace-pre-wrap">TechStart Website</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Regular',sans-serif] h-[24px] justify-center leading-[0] left-[32px] not-italic text-[#a1a1a1] text-[16px] top-[590.5px] w-[504.807px]">
        <p className="leading-[24px] whitespace-pre-wrap">Modern landing page and marketing website for a tech startup</p>
      </div>
      <Button3 />
      <Background4 />
    </div>
...
function TaskProDashboard() {
  return (
    <div className="absolute inset-0 opacity-60" data-name="TaskPro Dashboard">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[105.17%] left-0 max-w-none top-[-2.58%] w-full" src={imgFinanceFlowSaaS} />
      </div>
    </div>
...
function OverlayBorder3() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] border-solid h-[708.5px] left-[656px] overflow-clip right-0 rounded-[24px] top-[920.5px]" data-name="Overlay+Border">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[20px] justify-center leading-[0] left-[32px] not-italic text-[#c27aff] text-[14px] top-[510.5px] w-[94.726px]">
        <p className="leading-[20px] whitespace-pre-wrap">SaaS Product</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:SemiBold',sans-serif] h-[32px] justify-center leading-[0] left-[32px] not-italic text-[24px] text-white top-[554.5px] w-[242.29px]">
        <p className="leading-[32px] whitespace-pre-wrap">TaskPro Dashboard</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Regular',sans-serif] h-[24px] justify-center leading-[0] left-[32px] not-italic text-[#a1a1a1] text-[16px] top-[590.5px] w-[417.423px]">
        <p className="leading-[24px] whitespace-pre-wrap">Project management tool with intuitive task tracking</p>
      </div>
      <Button4 />
      <Background6 />
    </div>
...
function Container2() {
  return (
    <div className="absolute h-[1629px] left-[80px] right-[80px] top-[128px]" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:SemiBold',sans-serif] h-[48px] justify-center leading-[0] left-0 not-italic text-[48px] text-white top-[24px] w-[423.95px]">
        <p className="leading-[48px] whitespace-pre-wrap">Selected Projects</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Poppins:Regular',sans-serif] h-[28px] justify-center leading-[0] left-0 not-italic text-[#a1a1a1] text-[20px] top-[78px] w-[733.593px]">
        <p className="leading-[28px] whitespace-pre-wrap">Crafting meaningful experiences across web, mobile, and SaaS platforms</p>
      </div>
      <OverlayBorder />
      <OverlayBorder1 />
      <OverlayBorder2 />
...
function Section() {
  return (
    <div className="bg-[#0a0a0a] h-[1885px] relative shrink-0 w-[1440px]" data-name="Section">
      <Container2 />
    </div>
  );
}
...
function AboutUs() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center justify-center overflow-clip px-[80px] py-[60px] relative shrink-0 w-[1440px]" data-name="About Us">
      <Placeholder />
      <Section />
    </div>
  );
...
export default function Reference() {
  return (
    <div className="bg-[#0a0a0a] content-stretch flex flex-col items-start relative size-full" data-name="Reference">
      <Hero />
      <Clients />
      <AboutUs />
    </div>

import svgPaths from "./svg-r5d5h5eiwj";
...
function Image() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Image">
      <Image1 />
    </div>
  );
}
...
function Cta() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0" data-name="CTA">
...
export default function Hovered() {
  return (
    <div className="bg-[#0a0a0a] content-stretch flex flex-col items-start relative rounded-[20px] size-full" data-name="Hovered">
      <Image />
      <Content />
    </div>
  );

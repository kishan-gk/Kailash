import svgPaths from "./svg-p5n9knfhvb";
...
function Company() {
  return (
    <div className="content-stretch flex h-[48px] items-start overflow-clip relative shrink-0 w-full" data-name="company">
...
function Title() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11px] items-start max-w-[250px] min-h-px min-w-px relative" data-name="title">
      <Company />
...
function Dot() {
  return <div className="bg-white opacity-40 rounded-[999px] shrink-0 size-[8px]" data-name="Dot" />;
}
...
function Hero() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Hero">
      <ServiceBlock />
    </div>
  );
}
...
function Company3() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] min-w-[450px] relative rounded-[20px] shrink-0 w-full z-[3]" data-name="Company 3">
      <div className="content-stretch flex gap-[20px] items-start min-w-[inherit] p-[20px] relative w-full">
        <Title />
        <Hero />
      </div>
    </div>
...
function Group() {
  return (
    <div className="col-1 h-[48px] ml-0 mt-0 relative row-1 w-[239.532px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 239.531 48">
        <g id="Group">
          <path d={svgPaths.p3f150f80} fill="var(--fill-0, #E73147)" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p314d2980} fill="var(--fill-0, #5271FF)" fillRule="evenodd" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function GeneralIcon6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center opacity-40 pt-[20px] px-[8px] relative self-stretch shrink-0" data-name="General Icon">
      <Dot4 />
      <Frame2 />
    </div>
  );
...
function GeneralIcon9() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center opacity-40 px-[8px] relative self-stretch shrink-0" data-name="General Icon">
      <Frame3 />
      <Dot6 />
      <Frame4 />
    </div>
